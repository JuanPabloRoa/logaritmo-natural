...
return 2*(((x-1)/(x+1))+
	f1*(A/(x+1))*(A/(x+1))*(A/(x+1))+
	f2*(A/(x+1))*(A/(x+1))*(A/(x+1))*(A/(x+1))*(A/(x+1))+
	f3*(A/(x+1))*(A/(x+1))*(A/(x+1))*(A/(x+1))*(A/(x+1))*(A/(x+1))*(A/(x+1))+
	f4*(A/(x+1))*(A/(x+1))*(A/(x+1))*(A/(x+1))*(A/(x+1))*(A/(x+1))*(A/(x+1))*(A/(x+1))*(A/(x+1))+
    f5*(A/(x+1))*(A/(x+1))*(A/(x+1))*(A/(x+1))*(A/(x+1))*(A/(x+1))*(A/(x+1))*(A/(x+1))*(A/(x+1))*(A/(x+1))*(A/(x+1))+
    f6*(A/(x+1))*(A/(x+1))*(A/(x+1))*(A/(x+1))*(A/(x+1))*(A/(x+1))*(A/(x+1))*(A/(x+1))*(A/(x+1))*(A/(x+1))*(A/(x+1))*(A/(x+1))*(A/(x+1))
